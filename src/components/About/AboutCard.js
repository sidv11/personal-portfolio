      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />I’m a Compute Science Engineering graduate with a primary focus on Data Science and Artificial Intelligence, working on building data-driven and machine learning solutions for real-world problems. Alongside this, I have hands-on experience in full-stack development and software testing, which helps me build reliable and end-to-end systems.
            <br />
            <br />
